...
|----|-------------|----------------|
| 00 | [docs/00_Overview.md](00_Overview.md) | コンセプトと思想 / Concept and philosophy |
| 01 | [docs/01_DataSpec.md](01_DataSpec.md) | カードデータ取り扱い仕様 / Card handling within Zipline |
| 02 | [docs/02_UI_Behavior.md](02_UI_Behavior.md) | UI挙動と編集フロー / User interface behavior and flow |
| 03 | [docs/03_Validation.md](03_Validation.md) | 検証とステータス評価 / Validation and status logic |
| 04 | [docs/04_EditorMeta.md](04_EditorMeta.md) | エディタメタ構造 / Editor meta-data structure |
| 05 | [docs/05_GitStructure.md](05_GitStructure.md) | Git運用ルール / Git structure and commit policy |
| 06 | [docs/06_FuturePlans.md](06_FuturePlans.md) | 将来拡張・駐車場 / Future extensions and parking ideas |
